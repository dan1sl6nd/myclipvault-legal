...
By accessing or using MyClipVault - Smart Clipboard ("the App"), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the App.

## Description of Service

MyClipVault is a clipboard manager application that allows you to:
- Store and organize clipboard history
- Automatically detect content types (URLs, emails, phone numbers, etc.)
- Search and filter clipboard items
- Access clipboard history across your devices (Pro feature)
...
### Free Trials
- If offered, free trials allow you to try Pro features before being charged
- Your subscription begins immediately after the free trial period ends
- You may cancel during the free trial period to avoid charges
...
### Data Collection
- We collect minimal usage data for subscription management through Apple's StoreKit 2
- No personal clipboard content is collected or transmitted to third parties
- All subscription data is processed securely through Apple's infrastructure
...
- Not store sensitive passwords or financial information (use a password manager instead)
- Not attempt to reverse engineer or modify the App
- Comply with all applicable laws and regulations

You agree NOT to:
- Use the App to store or transmit illegal content
- Attempt to bypass subscription limitations
- Share your subscription with others
- Use the App in a way that could harm our services

## Intellectual Property

- The App and all content, features, and functionality are owned by MyClipVault and are protected by copyright, trademark, and other intellectual property laws
...
- You are responsible for backing up important clipboard items
- We recommend not relying solely on the App for critical data storage
...
- These Terms are between you and MyClipVault, not Apple
...
All purchases are final and processed through Apple. Refund requests must be submitted through Apple:

1. Go to reportaproblem.apple.com
2. Sign in with your Apple ID
3. Select "Request a refund"
4. Choose the purchase and submit your request

Apple will review and decide on refund requests according to their policies.

---

By using MyClipVault, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
